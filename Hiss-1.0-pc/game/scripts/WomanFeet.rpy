...
label WomanFeet:
    ...
    scene bg_womanroomwithoutfeet with dissolve:
        zoom 0.5
    
    show Idris Blood1 at right with dissolve

    show screen WomanFeet_screen with dissolve

    show glowing_bag with dissolve:
        xysize(175,175)

    "You need to drag and drop this old woman's feet into your inventory."

    while not isFeetTaken:
        "You need to drag and drop this old woman's feet into your inventory."
        show glowing_bag with dissolve:
            xysize(175,175)
    ...
    if isFeetTaken == True:
        ...
        jump WomanFeetContinue

    label WomanFeetContinue:
